...
/***/ (function(module, exports, __webpack_require__) {
	...
	var helpers = {
	  ...
	  lazyLoadSlides: function lazyLoadSlides() {
	    var newLazyLoadedList = this.state.lazyLoadedList.concat(this.getLazyLoadList(this.state.currentSlide)).concat(this.props.lazyLoadList).filter(function (elem, index, array) {
